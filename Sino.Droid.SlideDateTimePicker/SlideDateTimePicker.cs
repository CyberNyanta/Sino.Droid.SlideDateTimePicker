...
namespace Sino.Droid.SlideDateTimePicker
{
    public class SlideDateTimePicker
    {
        ...
        private ISlideDateTimeListener mListener;
        private int mTheme;
        ...
        public void SetListener(ISlideDateTimeListener listener)
        {
            mListener = listener;
        }
        ...
        public class Builder
        {
            ...
            private ISlideDateTimeListener listener;
            ...
            public Builder SetListener(ISlideDateTimeListener listener)
            {
