    ...
    public class CustomDatePicker : DatePicker
    {
            ...
            : base(context, attrs)
        {
            try
            {
                ...
                selectionDividerField.Set(monthNumberPicker, Resources.GetDrawable(Resource.Drawable.sino_sdtp_selection_divider));
                selectionDividerField.Set(dayNumberPicker, Resources.GetDrawable(Resource.Drawable.sino_sdtp_selection_divider));
                selectionDividerField.Set(yearNumberPicker, Resources.GetDrawable(Resource.Drawable.sino_sdtp_selection_divider));
            }
