...
namespace Sino.Droid.SlideDateTimePicker
{
    public class SlideDateTimeDialogFragment : Android.Support.V4.App.DialogFragment, IDateChangedListener, ITimeChangedListener
    {
        ...
        private static ISlideDateTimeListener mListener;
        ...
        public static SlideDateTimeDialogFragment NewInstance(ISlideDateTimeListener listener,
        ...
        {
            View view = inflater.Inflate(Resource.Layout.sino_sdtp_slide_date_time_picker, container);
        ...
        {
            int lineColor = mTheme == SlideDateTimePicker.HOLO_DARK ? Resources.GetColor(Resource.Color.sino_sdtp_gray_holo_dark) : Resources.GetColor(Resource.Color.sino_sdtp_gray_holo_light);
            ...
            switch (mTheme)
            {
                ...
                default:
                    {
                        mButtonHorizontalDivider.SetBackgroundColor(Resources.GetColor(Resource.Color.sino_sdtp_gray_holo_light));
                        mButtonVerticalDivider.SetBackgroundColor(Resources.GetColor(Resource.Color.sino_sdtp_gray_holo_light));
                    }
                    break;
            }
        ...
        private void InitViewPager()
        {
            ...
            mSlidingTabLayout.SetCustomTabView(Resource.Layout.sino_sdtp_custom_tab, Resource.Id.tabText);
